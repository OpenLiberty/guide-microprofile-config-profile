...
// =================================================================================================
== Developing the query service with the system service running in testing environment

Develop the `query` service against where the `system` service is running in the testing enivronment.
