...
// =================================================================================================
== Trying the basic configuration

Run the `query` service in development mode with the `system` service that is running in the testing enivronment.
...
// =================================================================================================
=== Switching the system service to development mode

Assume that the `system` service is required to fix something. The `query` service need connect to its development environment instead of testing environment.
...
=== Running the tests in testing environment
