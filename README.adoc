...
image::system-query-devops.png[System and query services DevOps,align="center",width=70%,height=70%]
...
image::system-query-devops-development.png[System service running in development environment,align="center",width=70%,height=70%]
...
image::system-query-devops-testing.png[System service running in testing environment,align="center",width=70%,height=70%]
