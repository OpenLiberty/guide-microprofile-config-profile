...
Open a command-line session and run the following commands to navigate to the `start` directory and start the `system` service in the `dev` environment:
...
Open another command-line session and run the following commands to navigate to the `start` directory and start the `query` service in the `dev` environment:
