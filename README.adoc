...
:page-seo-description: A tutorial and example on how to externalize configuration of Java microservices and applications for different deployment environmtns in the CI/CD lifecycle using MicroProfile Config configuration profiles.
